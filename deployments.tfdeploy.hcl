...
# Access the IBM Instana License Key from variables set "tfstacks_vars_instana"
store "varset" "stacks_instana_config" {
  name     = "tfstacks_vars_instana"
  category = "terraform"
}
...
deployment "eks-team3-pranit-dev" {
  ...
  inputs = {
    ...
    instana_agent_key     = store.varset.stacks_instana_config.stable.instana_key
    instana_endpoint_host = "ingress-blue-saas.instana.io"
    instana_endpoint_port = 443
